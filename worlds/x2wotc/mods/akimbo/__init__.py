...
items: dict[str, X2WOTCItemData] = {
    "AkimboRank": X2WOTCItemData(
        display_name = PROMOTION_ITEM_PREFIX + "Akimbo",
        id = get_new_item_id(),
...
config: dict[str, str] = {
    "WOTCArchipelago_Ranksanity": f'+RanksanityData=(ID="Akimbo", ClassName="Akimbo", {RANKS_STR})'
}
