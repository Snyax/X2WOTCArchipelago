...
items: dict[str, X2WOTCItemData] = {
    "AlphaCommandoRank": X2WOTCItemData(
        display_name = PROMOTION_ITEM_PREFIX + "Commando",
        id = get_new_item_id(),
...
config: dict[str, str] = {
    "WOTCArchipelago_Ranksanity": f'+RanksanityData=(ID="AlphaCommando", ClassName="AlphaCommando", {RANKS_STR})'
}
