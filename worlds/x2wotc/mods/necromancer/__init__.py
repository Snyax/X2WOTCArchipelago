...
locations: dict[str, X2WOTCLocationData] = {
    f"NecromancerClassWOTCRank{rank}": X2WOTCLocationData(
        display_name = SOLDIER_RANK_LOCATION_PREFIX + "Necromancer" + SOLDIER_RANK_LOCATION_INFIX + DEFAULT_RANK_NAMES[rank],
...
config: dict[str, str] = {
    "WOTCArchipelago_Ranksanity": f'+RanksanityData=(ID="Necromancer", ClassName="Necromancer", {RANKS_STR})'
}
